        ...
        <div className="group relative">
          ...
          {token && <div className="hidden group-hover:block absolute right-0 pt-4 bg-white shadow-md rounded">
            <div className="flex flex-col gap-2 w-36 py-3 px-5 bg-slate-100 text-gray-500 rounded">
              ...
              <p onClick={()=> navigate('/returns')} className="cursor-pointer hover:text-black">Returns</p>
              <p onClick={()=> navigate('/addresses')} className="cursor-pointer hover:text-black">Addresses</p>
              <p onClick={()=> navigate('/loyalty')} className="cursor-pointer hover:text-black">💎 Loyalty</p>
